...
urlpatterns = [
    ...
    path('kontakrtlh/', kontakrtlh.KontakViews.as_view(), name = 'kontak'),
    path('daftar/', daftar.DaftarViews.as_view(), name = 'daftar'),
    path('infortlh/', infortlh.InformasiViews.as_view(), name = 'informasi'),
    ...
    path('infortlh_detail/<int:id_info>/', infortlh_detail.InfoDetailViews.as_view(), name = 'infodetail'),
] 
