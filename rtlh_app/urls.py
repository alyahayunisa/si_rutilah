...
urlpatterns = [
    ...
    path('edit/<int:id_daftar>', daftar.EditDaftarViews.as_view(), name = 'edit_daftar'),
    path('delete/<int:id_daftar>', daftar.DeleteDaftarViews.as_view(), name = 'delete_daftar'),
    path('detail/<int:id_daftar>', detail.DetailDaftarViews.as_view(), name = 'detail'),
