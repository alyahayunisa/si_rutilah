...
class keterangan(models.Model):
    ...
    kerusakan = models.CharField(max_length=300, null=True, blank=True)
    kriteria = models.ForeignKey(data_kriteria, on_delete=models.SET_NULL, null=True, related_name='keterangan')
...
class data_rtlh(models.Model):
    ...
    kriteria = models.ForeignKey(data_rumah, on_delete=models.SET_NULL, null=True, related_name='rtlh_kriteria')
    img_rumah = models.ImageField(upload_to='media/')
